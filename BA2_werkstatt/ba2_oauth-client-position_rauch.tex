...
Als Standard für Authorisierung in MSA wird vielfach OAuth 2.0 (OAuth2) eingesetzt, das in RFC 6749 \cite{hardtOAuthAuthorizationFramework2012} und 6750 \cite{jonesOAuthAuthorizationFramework2012} definiert ist. Allerdings ist damit eine hohe Anzahl an weiteren Dokumenten verknüpft, die im Lauf der Jahre dazugekommen sind. Es kann für Developer eine Herausforderung darstellen, den Überblick zu behalten und darauf zu achten, alle Anforderungen für OAuth2 zu erfüllen und auch aktuelle Best Practice Vorgaben zu berücksichtigen \cite{pareckiItTimeOAuth2019}. Seit kurzem gibt es die langersehnte Specification für OAuth 2.1, die diese Situation verbessern soll \cite{hardtOAuthAuthorizationFramework2023}. OAuth2 behandelt nur Authorisierung. Für Authentifizierung wurde OpenID Connect als zusätzliche Schickt in Kombination mit OAuth2 entwickelt !!! Quelle!.
