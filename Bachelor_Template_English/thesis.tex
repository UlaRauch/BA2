...
\vspace{0.2cm}
\hspace*{-1.0cm} : Evaluation of Performance, Complexity and Security of a Spring Boot Implementation in two variants together with a Keycloak Server\\
...
Froschungsfrage: The goal is ... therefore -> forschungsfragen.
